 ...
 * @author patri
 */
public class FrmSeleccionarTrabajadorSalida extends javax.swing.JDialog {
    ...
    public FrmSeleccionarTrabajadorSalida(java.awt.Frame parent,FrmVenta frm, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        this.setTitle("Seleccionar un trabajador para la venta");
