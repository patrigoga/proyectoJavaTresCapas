...
public class FrmVenta extends javax.swing.JInternalFrame {
    ...
    public void agregarDetalles(String id, String referencia, String nombre) {
        ...
        if (existe) {
            ...
            this.mensajeError("El Deposito ya ha sido agregado");
        } else {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnVerVenta, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSeleccionarTrabajadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarTrabajadorActionPerformed
        FrmSeleccionarTrabajadorSalida frm = new FrmSeleccionarTrabajadorSalida(contenedor, this, true);
        frm.toFront();
    ...
    private void btnBucarDepositoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBucarDepositoActionPerformed
        FrmSelecionarDepositoSalida frm = new FrmSelecionarDepositoSalida(contenedor, this, true);
    ...
    private void txtCodigoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoKeyReleased
        if (txtCodigo.getText().length() > 0) {
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                dep = this.CONTROL.obtenerDepositoCodigoVemta(txtCodigo.getText());
                if (dep == null) {
