...
public class Usuario {
    ...
    public Usuario(int id, String rolNombre) {
        this.id = id;
        this.rolNombre = rolNombre;
    }
    ...
    public String toString() {
        return "Usuario{" + "id=" + id + ", rolId=" + rolId + ", rolNombre=" + rolNombre + ", nombre=" + nombre + ", tipoDocumento=" + tipoDocumento + ", numDocumento=" + numDocumento + ", direccion=" + direccion + ", telefono=" + telefono + ", email=" + email + ", clave=" + clave + ", activo=" + activo + '}';
    }
